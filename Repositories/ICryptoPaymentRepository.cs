...
namespace real_proxy_api.Repositories
{
    public interface ICryptoPaymentRepository
    {
        ...
        Task<bool> UpdateStatusAsync(string orderId, string status, string? traceId = null, string? paymentAssetId = null, string? paymentAmount = null, string? txid = null, string? blockExplorerUrl = null, DateTime? completedAt = null);
